...
async function signMessage(methodName) {
    if (window.ethereum) {
        ...
        try {
            ...
            const message = `DecryptMarketplace uses this cryptographic signature in place of a password, verifying that you are the owner of this Ethereum address - ${timestamp}`;
