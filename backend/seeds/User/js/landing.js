                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <p class="mb-0 meta-price font-family-bs-regular text-center text-lg-left">
                                        Base Price:- ${result.data[0].mostViewed[nData].nBasePrice.$numberDecimal} MATIC</p>
                                </div>
                                <div class="col-lg-6">
                                    <p
                    ...
                    <div class="nft-card id_${result.data[0].recentlyAdded[nData]._id}">
                        ...
                        <div class="nft-card-footer">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <p class="mb-0 meta-price font-family-bs-regular text-center text-lg-left">
                                        Base Price:- ${result.data[0].recentlyAdded[nData].nBasePrice.$numberDecimal} MATIC</p>
                                </div>
                                <div class="col-lg-6">
                                    <p
                                        class="mb-0 text-capitalize font-family-bs-regular meta-cat text-center text-lg-right">
                    ...
                    <div class="nft-card id_${result.data[0].onSale[nData]._id}">
                        ...
                        <div class="nft-card-footer">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <p class="mb-0 meta-price font-family-bs-regular text-center text-lg-left">
                                        Base Price:- ${result.data[0].onSale[nData].nBasePrice.$numberDecimal} MATIC</p>
                                </div>
                                <div class="col-lg-6">
                                    <p
                                        class="mb-0 text-capitalize font-family-bs-regular meta-cat text-center text-lg-right">
                    ...
                    <div class="nft-card id_${result.data[0].onAuction[nData]._id}">
                        ...
                        <div class="nft-card-footer">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <p class="mb-0 meta-price font-family-bs-regular text-center text-lg-left">
                                        Base Price:- ${result.data[0].onAuction[nData].nBasePrice.$numberDecimal} MATIC</p>
                                </div>
                                <div class="col-lg-6">
                                    <p
                                        class="mb-0 text-capitalize font-family-bs-regular meta-cat text-center text-lg-right">
