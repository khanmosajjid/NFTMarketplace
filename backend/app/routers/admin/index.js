...
router.post('/toggleNFTStatus', adminMiddleware.verifyToken, adminController.toggleNFTStatus);
...
//CMS
router.post('/insertBanner', adminMiddleware.verifyToken, adminController.insertBanner);
router.post('/getbanners', adminMiddleware.verifyToken, adminController.getbanners);
router.post('/deleteBanner', adminMiddleware.verifyToken, adminController.deleteBanner); 
router.post('/getSingleBanner', adminMiddleware.verifyToken, adminController.getSingleBanner); 
router.post('/updateSingleBanner', adminMiddleware.verifyToken, adminController.updateSingleBanner)
