...
router.post(
  "/toggleNFTStatus",
  adminMiddleware.verifyToken,
  adminController.toggleNFTStatus
);
...
router.post(
  "/sendNewsLetterEmail",
  adminMiddleware.verifyToken,
  adminController.sendNewsLetterEmail
);
router.post(
  "/getNewsLetterEmailsLists",
  adminMiddleware.verifyToken,
  adminController.getNewsLetterEmailsLists
);
router.delete(
  "/deleteNewsLetterEmail",
  adminMiddleware.verifyToken,
  adminController.deleteNewsLetterEmail
);
...
router.post(
  "/getSingleBanner",
  adminMiddleware.verifyToken,
  adminController.getSingleBanner
);
router.post(
  "/updateSingleBanner",
  adminMiddleware.verifyToken,
  adminController.updateSingleBanner
);
